...
// const ClaimPage = (props: ClaimAction) => {
...
//       {modelProgress === "verify" && <VerifyModal />}

//       {modelProgress === "donate" && <DonationModal />}
...
//           return Promise.resolve({ github: null, success: true });
//         }
...
// const VerifyModal = (props: Partial<Props>) => {
//   let [account, setAccountInfo] = useContext();
